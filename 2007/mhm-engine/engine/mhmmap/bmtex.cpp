...
#define BITMAPTEX_INTERFACE_MAYHEM Interface_ID(0x706a4d9a, 0x3942188b)
...
static Class_ID bmTexClassID(0x2e911d7, 0);
...
//watje
		BaseInterface* GetInterface(Interface_ID id) 
			{ 
			if (id == BITMAPTEX_INTERFACE_MAYHEM) 
...
//      internal name is hardwired since it must not be localized.
	const TCHAR*	InternalName() { return _T("bitmapMayhemTex"); }	// returns fixed parsable name (scripter-visible name)
...
ClassDesc* GetMayhemMapDesc() { return &bmTexCD;  }
...
static FPInterfaceDesc bitmaptex_interface(
    BITMAPTEX_INTERFACE_MAYHEM, _T("bitmapMayhemTex"), 0, &bmTexCD, FP_MIXIN,
